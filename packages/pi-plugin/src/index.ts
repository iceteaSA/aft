...
const ANNOUNCEMENT_FEATURES: string[] = [
  "read now hands images (PNG, JPEG, GIF, WebP) to vision-capable models as visual attachments instead of a binary placeholder, downsized to stay light in context.",
];
