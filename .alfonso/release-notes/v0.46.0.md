...
80 commits since v0.45.1. This release hardens the daemon (subc) execution path end to end, fixes a broken TUI sidebar on current OpenCode versions, and unifies storage resolution across all entry points.
